...
#
#   expect_that(plot.moveData(data),not(throws_error()))
#
#   data <- data.frame()
#   expect_that(plot.moveData(data),throws_error("The data input is empty."))
#
#   data <- data.frame(x=x,y=y)
#   expect_that(plot.moveData(data),throws_error())
})
