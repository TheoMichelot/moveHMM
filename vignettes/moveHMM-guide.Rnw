...
\title{\texttt{moveHMM}\\ An R package for the analysis of animal movement data}
...
The package is presented in \cite{michelot16}, where its use is illustrated on simulated movement data of wild haggises.
...
Bivand, R., Keitt, T., and Rowlingson, B. (2016) 
...
\bibitem[\protect\citeauthoryear{Jonsen et al.}{2005}]{jonsen2005}
  Jonsen, I.D., Flemming, J.M., Myers, R.A. (2005),
...
\bibitem[\protect\citeauthoryear{McClintock et al.}{2012}]{mcclintock2012}
  McClintock, B.T., King, R., Thomas, L., Matthiopoulos, J., McConnell, B.J., Morales, J.M. (2012),
...
\bibitem[\protect\citeauthoryear{Michelot et al.}{in press}]{michelot16}
  Michelot, T., Langrock, R., Patterson, T.A. (in press),
  ``moveHMM: an R package for analysing animal movement data using hidden Markov models'',
  \textit{Methods in Ecology and Evolution}. DOI: 10.1111/2041-210X.12578.
...
\bibitem[\protect\citeauthoryear{Patterson et al.}{2016}]{patterson16}
  Patterson T.A., Parton, A., Langrock, R., Blackwell, P.G., Thomas, L., King, R. (2016),
